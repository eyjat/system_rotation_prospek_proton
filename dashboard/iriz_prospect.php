...
$tableName = "irizData"; //set table name here
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>iriz Prospect</title></head><body>');
                            printWindow.document.write('<h3>iriz Prospect</h3>');
