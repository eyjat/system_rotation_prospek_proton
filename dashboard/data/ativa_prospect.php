...
$tableName = "ativaData"; //set table name here
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>Ativa Prospect</title></head><body>');
                            printWindow.document.write('<h3>Ativa Prospect</h3>');
