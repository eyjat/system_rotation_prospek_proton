...
$tableName = "axiaData"; //set table name here
...
?>
    ...
    <!-- dropdown selection for sales agent -->
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        ...
                        //script for clear filter button
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>Axia Prospect</title></head><body>');
                            printWindow.document.write('<h3>Axia Prospect</h3>');
