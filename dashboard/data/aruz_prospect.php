...
$tableName = "aruzData"; //set table name here
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>Aruz Prospect</title></head><body>');
                            printWindow.document.write('<h3>Aruz Prospect</h3>');
