...
$tableName = "x70Data"; //set table name here
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>x70 Prospect</title></head><body>');
                            printWindow.document.write('<h3>x70 Prospect</h3>');
