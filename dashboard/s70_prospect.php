...
$tableName = "s70Data"; //set table name here
 ...
 <!-- Add search input, date inputs, and sales agent dropdown here -->
                    ...
                    <script>
                        function printTable() {
                            ...
                            printWindow.document.write('<html><head><title>s70 Prospect</title></head><body>');
                            printWindow.document.write('<h3>s70 Prospect</h3>');
