...
<head>
    ...
    <title>Prospect Form Persona</title>
...
<body background="/pic/wallpaper.png" class="bg-gray-100 p-4 md:p-0 flex items-center justify-center h-screen">
    <div class="max-w-sm w-full bg-white rounded-lg shadow-md p-6">
        <img src="/pic/model/personalogo.png" alt="Persona Logo" class="w-48 mx-auto mb-10"> <!--model logo-->
        <form action="controller/process_form.php" method="post">
            ...
            <label for="prosName" class="block mt-4 mb-2" font="white">Name :</label>
